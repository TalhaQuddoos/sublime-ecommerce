+<div class="avds">
    <div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
        <div class="avds_small">
            <div class="avds_background" style="background-image:url(/assets/images/xavds_small.jpg.pagespeed.ic.DTdXDpOXu1.jpg)"></div>
            <div class="avds_small_inner">
                <div class="avds_discount_container">
                    <img src="/assets/images/xdiscount.png.pagespeed.ic.VNaqVnmnHZ.png" alt="">
                    <div>
