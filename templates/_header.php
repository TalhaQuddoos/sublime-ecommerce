                ...
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <nav class="main_nav">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><a href="/categories" class="text-left">Categories</a></li>
                                <li><a href="/products" class="text-left">Products</a></li>
                        ...
                        <div class="header_extra ml-auto">
                            <div class="shopping_cart">
                                <a href="/cart">
                                    ...
                                    <div>Cart <span>(</span><span id="cartCount" style="margin-left: 0;"><?=$cartCount ?></span>)</div>
                                </a>
                            </div>
                            <div class="search">
                ...
                <div class="col">
                    <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                        <form action="/products">
                            <input type="text" class="search_input" placeholder="Search" required name="search_query" value="<?php $_GET['search_query'] ?? "" ?>">
                        </form>
                    </div>
                </div>
            </div>
